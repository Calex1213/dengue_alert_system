...
build_city_env_horizon_features <- function(horizon, keep_per_var, lag_train_end_year) {
...
write_csv(city_horizon_metrics, file.path(OUTPUT_DIR, paste0("city_week_environmental_only_lightgbm_H0_TO_H12_metrics_", OUTPUT_PREFIX, ".csv")))
write_csv(city_horizon_predictions, file.path(OUTPUT_DIR, paste0("city_week_environmental_only_lightgbm_H0_TO_H12_predictions_", OUTPUT_PREFIX, ".csv")))
write_csv(city_horizon_by_year, file.path(OUTPUT_DIR, paste0("city_week_environmental_only_lightgbm_H0_TO_H12_by_year_", OUTPUT_PREFIX, ".csv")))
write_csv(city_horizon_settings, file.path(OUTPUT_DIR, paste0("city_week_environmental_only_lightgbm_H0_TO_H12_selected_settings_", OUTPUT_PREFIX, ".csv")))
write_csv(city_horizon_importance, file.path(OUTPUT_DIR, paste0("city_week_environmental_only_lightgbm_H0_TO_H12_feature_importance_", OUTPUT_PREFIX, ".csv")))
...
write_csv(city_horizon_summary, file.path(OUTPUT_DIR, paste0("city_week_environmental_only_lightgbm_H0_TO_H12_compact_summary_", OUTPUT_PREFIX, ".csv")))

write_csv(city_horizon_metrics, file.path(METADATA_DIR, "environmental_city_metrics.csv"))
write_csv(city_horizon_summary, file.path(METADATA_DIR, "environmental_city_compact_summary.csv"))
write_csv(city_horizon_settings, file.path(METADATA_DIR, "environmental_city_selected_settings.csv"))
write_csv(city_horizon_importance, file.path(METADATA_DIR, "environmental_city_feature_importance.csv"))

cat("\n============================================================\n")
cat("CITY-WEEK ENVIRONMENTAL-ONLY LIGHTGBM H+0 TO H+12 SUMMARY\n")
cat("============================================================\n")
...
cat("\n============================================================\n")
cat("DONE: CITY-WEEK ENVIRONMENTAL-ONLY LIGHTGBM H+0 TO H+12 COMPLETED\n")
cat("============================================================\n")

cat("\nApp interpretation:\n")
cat("Use predicted_cases or environmental_lightgbm_cases as the final citywide environmental-only case forecast.\n")
cat("This model intentionally has no classifier-derived outbreak_probability because it is a pure environmental-only regressor.\n")
